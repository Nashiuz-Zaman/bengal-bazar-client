  ...
  return (
    ...
    >
      {(labelText || passwordField) && (
        ...
        >
          {labelText && (
            <p className={`text-inherit mb-2.5 capitalize ${labelTextClassName}`}>
              {labelText}
            </p>
          )}
          ...
          {passwordField && (
            <button
              ...
              className={`flex cursor-pointer items-center gap-1.5 ml-auto mr-1 text-inherit ${passwordShowIconBoxClassName}`}
            >
              <Icon
      ...
      <div
        className={`bg-transparent border border-neutral-200 items-center w-full px-4 py-3 ${
          icon
            ? `grid ${
                invertIconPosition
                  ? "grid-cols-[auto_1fr]"
